        ...
        <div className="about-grid">
          ...
          <div className="about-content">
            ...
            <div className="about-description">
              ...
              <p>
                현대적인 웹 기술과 최신 프레임워크를 활용하여 직관적이고 반응성
                높은 웹 애플리케션을 개발합니다. 코드의 품질과 성능 최적화에
                관심이 많으며, 사용자들이 편리하게 사용할 수 있는 서비스를
                만드는 것을 목표로 합니다.
              </p>
              <p>
                새로운 기술을 배우고 적용하는 것에 열정을 가지고 있으며, 항상 더
                나은 코드, 더 나은 사용자 경험을 위해 노력하고 있습니다.
              </p>
            </div>
